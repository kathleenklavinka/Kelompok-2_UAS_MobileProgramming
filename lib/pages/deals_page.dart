...
import 'package:azzura_rewards/pages/deals_detail_page.dart';
          ...
          children: [
            ...
            Container(
              ...
              child: Stack(
                fit: StackFit.expand,
                children: [
                  // [UPDATE] Langsung menggunakan Image.asset tanpa logika emoji
                  ClipRRect(
                    borderRadius: const BorderRadius.vertical(top: Radius.circular(20)),
                    child: Image.asset(
                      deal['image'], // Pastikan ini path asset (misal: assets/b1g1.png)
                      fit: BoxFit.cover,
                  ...
                  // Overlay Gradient agar tulisan badge terbaca
                  Container(
                    decoration: BoxDecoration(
                      borderRadius: const BorderRadius.vertical(top: Radius.circular(20)),
                      gradient: LinearGradient(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.confirmation_number_outlined, color: AppColors.grayDark, size: 20),
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 11,
                          fontWeight: FontWeight.bold,
                          color: AppColors.redDark.withOpacity(0.8),
                        ),
                      ),
                      const SizedBox(width: 4),
                      Icon(Icons.arrow_forward_ios, size: 10, color: AppColors.redDark.withOpacity(0.8)),
                    ],
                  )
                ],
              ),
